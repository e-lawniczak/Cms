...
exports.TestimonialPage = void 0;
...
var TestimonialPage = function () {
    var _a = (0, react_1.useState)([]), data = _a[0], setData = _a[1], _b = (0, react_1.useState)(false), showNew = _b[0], setNew = _b[1], _c = (0, react_1.useState)(), testimonials = _c[0], setTestimonials = _c[1], _d = (0, react_1.useState)(), roles = _d[0], setRoles = _d[1], _e = (0, react_1.useState)(), pictures = _e[0], setPictures = _e[1], getTestimonials = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(common_1.baseApiUrl + "/GetAllTestimonialList", common_1.axiosBaseConfig)];
                case 1:
                    res = _a.sent();
                    setTestimonials(res.data.sort(function (a, b) { return (0, common_1.sortFunc)(a, b); }));
                    return [2 /*return*/];
            }
        });
    ...
    return React.createElement("div", { className: 'card mb-4' },
        ...
        React.createElement("div", { className: "generic-list" },
            React.createElement("div", { className: "testimonial-row row" },
            ...
            showNew && addNew,
            testimonials && testimonials.map(function (item, idx) { return React.createElement(TestimonialRow, { pictures: pictures, key: idx, item: item, isNew: false, roles: roles, refreshFunc: getTestimonials }); })));
};
    ...
    var item = props.item, isNew = props.isNew, _a = props.roles, roles = _a === void 0 ? [] : _a, refreshFunc = props.refreshFunc, showFunc = props.showFunc, pictures = props.pictures, rolesData = (0, common_1.mapObjectToSelect)(roles, "name", "id"), picturesData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _b = (0, react_hook_form_1.useForm)({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddTestimonial";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeleteTestimonial/" + item.id;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/UpdateTestimonial";
    ...
    return React.createElement("form", { className: '' },
        React.createElement("div", { className: "form-content " },
            React.createElement("div", { className: "testimonial-row row" },
                ...
                React.createElement("div", null, rolesData.length > 0 &&
...
ReactDOM.render(React.createElement(exports.TestimonialPage, null), root);
