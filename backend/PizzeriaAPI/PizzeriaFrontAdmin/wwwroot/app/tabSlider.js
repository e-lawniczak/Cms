...
var TabSliderPage = function () {
    var _a = (0, react_1.useState)([]), data = _a[0], setData = _a[1], _b = (0, react_1.useState)(false), showNew = _b[0], setNew = _b[1], _c = (0, react_1.useState)(), tabs = _c[0], setTabs = _c[1], _d = (0, react_1.useState)(), tabSliders = _d[0], setTabSliders = _d[1], _e = (0, react_1.useState)(), pictures = _e[0], setPictures = _e[1], getTabs = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
    ...
    }); }, addNew = React.createElement(TabSliderRow, { pictures: pictures, tabSliders: tabSliders, item: null, isNew: true, tabs: tabs, refreshFunc: getTabSliders, showFunc: setNew });
    ...
    return React.createElement("div", { className: 'card mb-4' },
        ...
        React.createElement("div", { className: "generic-list" },
            React.createElement("div", { className: "tab-slider-row row" },
                ...
                React.createElement("div", { className: 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7' }, "information tabs"),
                React.createElement("div", { className: 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7' }, "options")),
            showNew && addNew,
            tabSliders && tabSliders.map(function (item, idx) { return React.createElement(TabSliderRow, { pictures: pictures, key: idx, tabSliders: tabSliders, item: item, isNew: false, tabs: tabs, refreshFunc: getTabSliders }); })));
};
exports.TabSliderPage = TabSliderPage;
var TabSliderRow = function (props) {
    var item = props.item, isNew = props.isNew, _a = props.tabs, tabs = _a === void 0 ? [] : _a, refreshFunc = props.refreshFunc, tabSliders = props.tabSliders, showFunc = props.showFunc, pictures = props.pictures, tabSlidersData = (0, common_1.mapObjectToSelect)(tabSliders, "title", "id"), picturesData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _b = (0, react_hook_form_1.useForm)({
        ...
        return {
            ...
            informationTabIdList: (item === null || item === void 0 ? void 0 : item.informationTabIdList) || [],
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddTabSlider";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeleteTabSlider/" + item.id;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/UpdateTabSlider";
        ...
        React.createElement("div", { className: "form-content " },
            React.createElement("div", { className: "tab-slider-row row" },
                ...
                React.createElement("div", null, tabs.length > 0 &&
                    (tabs === null || tabs === void 0 ? void 0 : tabs.filter(function (i, idx) { return (item === null || item === void 0 ? void 0 : item.informationTabIdList.indexOf(i.informationTabId)) > -1; }).map(function (i, idx) { return React.createElement("div", { className: 'tabname' },
                        i.title,
...
ReactDOM.render(React.createElement(exports.TabSliderPage, null), root);
