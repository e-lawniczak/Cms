...
var CategoriesPage = function () {
    var _a = (0, react_1.useState)([]), data = _a[0], setData = _a[1], _b = (0, react_1.useState)(false), showNew = _b[0], setNew = _b[1], _c = (0, react_1.useState)(), categories = _c[0], setCategories = _c[1], _d = (0, react_1.useState)(), pictures = _d[0], setPictures = _d[1], getCategories = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
    ...
    }); }, addNew = React.createElement(CategoryRow, { item: null, isNew: true, categories: categories, pictures: pictures, refreshFunc: getCategories, showFunc: setNew });
    ...
    return React.createElement("div", { className: 'card mb-4' },
        ...
        React.createElement("div", { className: "generic-list" },
            React.createElement("div", { className: "category-row row" },
                ...
                React.createElement("div", { className: 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7' }, "selected picture"),
                React.createElement("div", { className: 'text-uppercase text-secondary text-xxs font-weight-bolder opacity-7' }, "options")),
            showNew && addNew,
            categories && categories.map(function (item, idx) { return React.createElement(CategoryRow, { pictures: pictures, key: idx, item: item, isNew: false, categories: categories, refreshFunc: getCategories }); })));
};
exports.CategoriesPage = CategoriesPage;
var CategoryRow = function (props) {
    var _a;
    var item = props.item, isNew = props.isNew, _b = props.categories, categories = _b === void 0 ? [] : _b, refreshFunc = props.refreshFunc, showFunc = props.showFunc, pictures = props.pictures, categoriesData = (0, common_1.mapObjectToSelect)(categories, "name", "id"), picturesData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _c = (0, react_1.useState)([]), pickedBanners = _c[0], setPickedBanners = _c[1], _d = (0, react_hook_form_1.useForm)({
        defaultValues: __assign({}, item)
    }), register = _d.register, handleSubmit = _d.handleSubmit, formState = _d.formState, getValues = _d.getValues, makeItem = function (data) {
        return {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddCategory";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeleteCategory/" + item.id;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/UpdateCategory";
    ...
    return React.createElement("form", { className: '' },
        React.createElement("div", { className: "form-content " },
            React.createElement("div", { className: "category-row row" },
                ...
                React.createElement("div", null, picturesData.length > 0 &&
                    ((_a = picturesData.filter(function (i) { return i.value == (item === null || item === void 0 ? void 0 : item.pictureIdList[0]); })[0]) === null || _a === void 0 ? void 0 : _a.label)),
...
ReactDOM.render(React.createElement(exports.CategoriesPage, null), root);
