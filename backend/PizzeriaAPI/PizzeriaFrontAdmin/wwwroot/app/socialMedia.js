...
exports.SocialMediaPage = void 0;
...
var SocialMediaPage = function () {
    var _a = (0, react_1.useState)(), socialMedia = _a[0], setSocialMedia = _a[1], _b = (0, react_1.useState)(), pictures = _b[0], setPictures = _b[1], _c = (0, react_1.useState)(), teamMembers = _c[0], setTeamMembers = _c[1], _d = (0, react_1.useState)(false), showNew = _d[0], setNew = _d[1], _e = (0, react_1.useState)([]), data = _e[0], setData = _e[1], getSocials = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSocials()];
                case 1:
                    _a.sent();
    ...
    return React.createElement(common_1.PageWrapper, null,
        React.createElement("div", { className: "card mb-4" },
            ...
            React.createElement("div", { className: "socials-list" },
                React.createElement("div", { className: "social-row row" },
                ...
                showNew && addNew,
                socialMedia && socialMedia.map(function (item, idx) { return React.createElement(SocialMediaRow, { key: idx, item: item, isNew: false, pictures: pictures, refreshFunc: getData }); }))));
};
...
var SocialMediaRow = function (props) {
    var item = props.item, isNew = props.isNew, pictures = props.pictures, refreshFunc = props.refreshFunc, setNew = props.setNew, picData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _a = (0, react_hook_form_1.useForm)({
        ...
        return {
            ...
            isMain: (data === null || data === void 0 ? void 0 : data.isMain) || false,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddSocialMedia";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeleteSocialMedia/" + item.id;
...
ReactDOM.render(React.createElement(exports.SocialMediaPage, null), root);
