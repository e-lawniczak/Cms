...
var RolePage = function () {
    var _a = (0, react_1.useState)([]), data = _a[0], setData = _a[1], _b = (0, react_1.useState)(false), showNew = _b[0], setNew = _b[1], _c = (0, react_1.useState)(), roles = _c[0], setRoles = _c[1], _d = (0, react_1.useState)(), pictures = _d[0], setPictures = _d[1], getRoles = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
    ...
    }); }, addNew = React.createElement(RoleRow, { item: null, isNew: true, roles: roles, pictures: pictures, refreshFunc: getRoles, showFunc: setNew });
    ...
    return React.createElement("div", { className: 'card mb-4' },
        ...
        React.createElement("div", { className: "generic-list" },
            React.createElement("div", { className: "role-row row" },
            ...
            showNew && addNew,
            roles && roles.map(function (item, idx) { return React.createElement(RoleRow, { pictures: pictures, key: idx, item: item, isNew: false, roles: roles, refreshFunc: getRoles }); })));
};
exports.RolePage = RolePage;
var RoleRow = function (props) {
    var item = props.item, isNew = props.isNew, _a = props.roles, roles = _a === void 0 ? [] : _a, refreshFunc = props.refreshFunc, showFunc = props.showFunc, pictures = props.pictures, rolesData = (0, common_1.mapObjectToSelect)(roles, "name", "roleId"), picturesData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _b = (0, react_1.useState)([]), pickedBanners = _b[0], setPickedBanners = _b[1], _c = (0, react_hook_form_1.useForm)({
        ...
        return {
            roleId: (item === null || item === void 0 ? void 0 : item.roleId) || -1,
            isVisible: (data === null || data === void 0 ? void 0 : data.isVisible) || false,
            name: (data === null || data === void 0 ? void 0 : data.name) || "",
            teamMemberIdList: (item === null || item === void 0 ? void 0 : item.teamMemberIdList) || [],
            testimonialIdList: (item === null || item === void 0 ? void 0 : item.testimonialIdList) || [],
        };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddRole";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeleteRole/" + item.roleId;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/UpdateRole";
    ...
    return React.createElement("form", { className: '' },
        React.createElement("div", { className: "form-content " },
            React.createElement("div", { className: "role-row row" },
                React.createElement("div", { className: "id" }, (item === null || item === void 0 ? void 0 : item.roleId) || -1),
...
ReactDOM.render(React.createElement(exports.RolePage, null), root);
