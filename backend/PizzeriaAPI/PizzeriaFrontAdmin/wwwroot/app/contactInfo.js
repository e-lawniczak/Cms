...
exports.ContactInfoPage = void 0;
...
var ContactInfoPage = function () {
    var _a = (0, react_1.useState)([]), data = _a[0], setData = _a[1], _b = (0, react_1.useState)(false), showNew = _b[0], setNew = _b[1], _c = (0, react_1.useState)(), contacts = _c[0], setContacts = _c[1], _d = (0, react_1.useState)(), pictures = _d[0], setPictures = _d[1], getContacts = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(common_1.baseApiUrl + "/GetAllContactInfoList", common_1.axiosBaseConfig)];
                case 1:
                    res = _a.sent();
                    setContacts(res.data.sort(function (a, b) { return (0, common_1.sortFunc)(a, b); }));
                    return [2 /*return*/];
            }
        });
    ...
    }); }, addNew = React.createElement(ContactRow, { item: null, isNew: true, contacts: contacts, pictures: pictures, refreshFunc: getContacts, showFunc: setNew });
    ...
    return React.createElement("div", { className: 'card mb-4' },
        ...
        React.createElement("div", { className: "generic-list" },
            React.createElement("div", { className: "contact-row row" },
            ...
            showNew && addNew,
            contacts && contacts.map(function (item, idx) { return React.createElement(ContactRow, { pictures: pictures, key: idx, item: item, isNew: false, contacts: contacts, refreshFunc: getContacts }); })));
};
exports.ContactInfoPage = ContactInfoPage;
var ContactRow = function (props) {
    var item = props.item, isNew = props.isNew, _a = props.contacts, contacts = _a === void 0 ? [] : _a, refreshFunc = props.refreshFunc, showFunc = props.showFunc, pictures = props.pictures, contactsData = (0, common_1.mapObjectToSelect)(contacts, "text", "id"), picturesData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _b = (0, react_1.useState)([]), pickedBanners = _b[0], setPickedBanners = _b[1], _c = (0, react_hook_form_1.useForm)({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddContactInfo";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeleteContactInfo/" + item.id;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/UpdateContactInfo";
...
ReactDOM.render(React.createElement(exports.ContactInfoPage, null), root);
