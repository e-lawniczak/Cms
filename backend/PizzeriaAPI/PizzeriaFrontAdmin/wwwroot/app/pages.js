...
var PagesPage = function () {
    var _a = (0, react_1.useState)([]), data = _a[0], setData = _a[1], _b = (0, react_1.useState)(false), showNew = _b[0], setNew = _b[1], _c = (0, react_1.useState)(), pages = _c[0], setPages = _c[1], _d = (0, react_1.useState)(), pictures = _d[0], setPictures = _d[1], getPages = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(common_1.baseApiUrl + "/GetAllPageList", common_1.axiosBaseConfig)];
                case 1:
                    res = _a.sent();
                    setPages(res.data.sort(function (a, b) { return (0, common_1.sortFunc)(a, b); }));
                    return [2 /*return*/];
            }
        });
    ...
    }); }, addNew = React.createElement(ContactRow, { item: null, isNew: true, pages: pages, pictures: pictures, refreshFunc: getPages, showFunc: setNew });
    ...
    return React.createElement("div", { className: 'card mb-4' },
        ...
        React.createElement("div", { className: "generic-list" },
            ...
            showNew && addNew,
            pages && pages.map(function (item, idx) { return React.createElement(ContactRow, { pictures: pictures, key: idx, item: item, isNew: false, pages: pages, refreshFunc: getPages }); })));
};
    ...
    var item = props.item, isNew = props.isNew, _a = props.pages, pages = _a === void 0 ? [] : _a, refreshFunc = props.refreshFunc, showFunc = props.showFunc, pictures = props.pictures, contactsData = (0, common_1.mapObjectToSelect)(pages, "title", "id"), picturesData = (0, common_1.mapObjectToSelect)(pictures, "name", "pictureId"), _b = (0, react_1.useState)([]), pickedBanners = _b[0], setPickedBanners = _b[1], _c = (0, react_hook_form_1.useForm)({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/AddPage";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/DeletePage/" + item.id;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = makeItem(data);
                    url = common_1.baseApiUrl + "/UpdatePage";
