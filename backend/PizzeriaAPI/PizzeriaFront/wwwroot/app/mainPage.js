...
var MainContent = function () {
    return React.createElement(React.Fragment, null,
        React.createElement("section", { className: "section swiper-container swiper-slider swiper-slider-2 swiper-slider-3", "data-loop": "true", "data-autoplay": "5000", "data-simulate-touch": "false", "data-slide-effect": "fade" },
            React.createElement("div", { className: "swiper-wrapper text-sm-left" },
                React.createElement("div", { className: "swiper-slide context-dark", "data-slide-bg": "images/slide-1-1920x753.jpg" },
                        ...
                        React.createElement("div", { className: "container" },
                            React.createElement("div", { className: "row" },
                                React.createElement("div", { className: "col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0" },
                                    React.createElement("h1", { className: "oh swiper-title" },
                                        React.createElement("span", { className: "d-inline-block", "data-caption-animate": "slideInUp", "data-caption-delay": "0" }, "Perfect pizza")),
                                    React.createElement("p", { className: "big swiper-text", "data-caption-animate": "fadeInLeft", "data-caption-delay": "300" }, "Experience the taste of a perfect pizza at PizzaHouse, one of the best restaurants!"),
                                    React.createElement("a", { className: "button button-lg button-primary button-winona button-shadow-2", href: "#", "data-caption-animate": "fadeInUp", "data-caption-delay": "300" }, "View our menu")))))),
                React.createElement("div", { className: "swiper-slide context-dark", "data-slide-bg": "images/slide-2-1920x753.jpg" },
                    React.createElement("div", { className: "swiper-slide-caption section-md" },
                        React.createElement("div", { className: "container" },
                            React.createElement("div", { className: "row" },
                                React.createElement("div", { className: "col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0" },
                                    React.createElement("h1", { className: "oh swiper-title" },
                                        React.createElement("span", { className: "d-inline-block", "data-caption-animate": "slideInDown", "data-caption-delay": "0" }, "Quality ingredients")),
                                    React.createElement("p", { className: "big swiper-text", "data-caption-animate": "fadeInRight", "data-caption-delay": "300" }, "We use only the best ingredients to make one-of-a-kind pizzas for our customers."),
                                    React.createElement("div", { className: "button-wrap oh" },
                                        React.createElement("a", { className: "button button-lg button-primary button-winona button-shadow-2", href: "#", "data-caption-animate": "slideInUp", "data-caption-delay": "0" }, "View our menu")))))))),
